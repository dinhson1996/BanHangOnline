...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng shopAd = new LatLng(21.0337161,105.761389);
        mMap.addMarker(new MarkerOptions().position(shopAd)
                .title("Poly Shop").snippet("A4 - Mỹ Đình 1, Đường Hàm Nghi, Mỹ Đình 1, Cầu Diễn, Từ Liêm, Hà Nội, Việt Nam")
                .icon(BitmapDescriptorFactory.defaultMarker()));
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(shopAd));
        mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(shopAd).zoom(10).build();
